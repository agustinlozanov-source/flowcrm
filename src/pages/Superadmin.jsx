          ...
          <div id="sa-quote-preview" style={{ background: '#070708', minHeight: '100%' }}>
            ...
            <div className="q2-header">
              <div style={{ position: 'relative', zIndex: 1 }}>
                <div className="q2-logo-row"><img src="/logo2.png" alt="Logo" style={{ height: 40, objectFit: "contain" }} /></div><div className="q2-title">Propuesta Comercial</div>
      ...
      <div className="sa-root">
        ...
        <div className="sa-login">
          <div className="sa-login-card">
            <div className="sa-login-logo" style={{ flexDirection: "column" }}><img src="/logo2.png" alt="Logo" style={{ height: 48, objectFit: "contain" }} /><span className="sa-logo-badge" style={{ marginTop: 8 }}>Superadmin</span></div><div className="sa-login-title">Acceso restringido</div>
