          ...
          <div id="sa-quote-preview" style={{ background: "#070708", color: "white", minHeight: "100%" }}>
            ...
            <div className="q2-header">
              <div style={{ position: 'relative', zIndex: 1 }}>
                <div className="q2-logo-row"><img src="/qubit%20corp.png" alt="Logo" style={{ height: 40, objectFit: "contain" }} /></div><div className="q2-title">Propuesta Comercial</div>
      ...
      <div className="sa-root">
        ...
        <div className="sa-login">
          <div className="sa-login-card">
            <div className="sa-login-logo" style={{ flexDirection: "column" }}><img src="/qubit%20corp.png" alt="Logo" style={{ height: 48, objectFit: "contain" }} /><span className="sa-logo-badge" style={{ marginTop: 8 }}>Superadmin</span></div><div className="sa-login-title">Acceso restringido</div>
      ...
      <div className="sa-layout">
        ...
        <div className="sa-sidebar">
          <div className="sa-sidebar-header">
            <div className="sa-login-logo" style={{ justifyContent: "flex-start", margin: 0, marginBottom: 4 }}><img src="/qubit%20corp.png" alt="Logo" style={{ height: 28, objectFit: "contain" }} /></div><div style={{ fontSize: 12, color: 'var(--gray-5)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Superadmin</div>
          </div>
