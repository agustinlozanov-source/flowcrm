...
const css = `
  ...
  .cp-logo-text { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 17px; font-weight: 800; }

  .cp-login-title { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 22px; font-weight: 900; text-align: center; margin-bottom: 4px; }
  .cp-login-sub { font-size: 12.5px; color: var(--gray-4); text-align: center; margin-bottom: 28px; line-height: 1.6; }

  .cp-input {
    width: 100%; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);
    border-radius: 9px; padding: 11px 14px; font-size: 13px; color: white;
  ...
  .cp-welcome { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 13px; font-weight: 600; color: var(--gray-4); margin-bottom: 2px; }
  .cp-name { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 22px; font-weight: 900; letter-spacing: -0.3px; }

  .cp-logout { font-size: 12px; color: var(--gray-5); background: none; border: none; cursor: pointer; font-family: 'Inter', sans-serif; padding: 6px 10px; border-radius: 6px; transition: all 0.15s; }
  ...
  .cp-progress-pct { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 18px; font-weight: 900; }

  .cp-progress-info { flex: 1; }
  .cp-progress-label { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 15px; font-weight: 800; margin-bottom: 4px; }
  .cp-progress-sub { font-size: 12.5px; color: var(--gray-4); line-height: 1.5; }
  ...
  .cp-tab {
    padding: 10px 16px; font-size: 13px; font-weight: 600; color: var(--gray-4);
  ...
  .cp-stage-name { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 13px; font-weight: 800; flex: 1; }
  .cp-stage-dates { font-size: 11px; color: var(--gray-4); }
  .cp-stage-badge {
    font-size: 10px; font-weight: 700; padding: 2px 8px; border-radius: 5px;
  }
  .cp-chevron { font-size: 10px; color: #3a3a3c; transition: transform 0.2s; }
  ...
  .cp-task-name { font-size: 12.5px; font-weight: 600; margin-bottom: 3px; color: white; }
  .cp-task-name.done { color: var(--gray-5); text-decoration: line-through; }
  .cp-task-how { font-size: 11.5px; color: var(--gray-4); line-height: 1.5; margin-bottom: 5px; }
  ...
  .cp-comment-btn {
    margin-left: auto; font-size: 10.5px; font-weight: 600; color: var(--gray-5);
  ...
  .cp-chat-title { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 13px; font-weight: 800; }
  ...
  .cp-msg-avatar { width: 26px; height: 26px; border-radius: 7px; display: flex; align-items: center; justify-content: center; font-size: 10px; font-weight: 800; flex-shrink: 0; }

  .cp-msg-bubble {
    background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.09);
    border-radius: 4px 12px 12px 12px; padding: 8px 12px;
    font-size: 13px; line-height: 1.55; max-width: 72%;
  }
  .cp-msg.mine .cp-msg-bubble {
    background: rgba(0,102,255,0.14); border-color: rgba(0,102,255,0.25);
    border-radius: 12px 4px 12px 12px;
  }
  .cp-msg-author { font-size: 10px; font-weight: 700; color: var(--gray-4); margin-bottom: 2px; }
  .cp-msg-time { font-size: 10px; color: #3a3a3c; margin-top: 3px; }
  ...
  .cp-docs-title { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 13px; font-weight: 800; flex: 1; }
  ...
  .cp-doc-name { font-size: 13px; font-weight: 600; flex: 1; }
  .cp-doc-meta { font-size: 11px; color: var(--gray-4); }

  .cp-upload-btn { display: inline-flex; align-items: center; gap: 6px; padding: 6px 12px; border-radius: 7px; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.1); color: white; font-size: 11.5px; font-weight: 600; cursor: pointer; transition: all 0.15s; font-family: 'Inter', sans-serif; }
  ...
  .cp-modal-title { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 15px; font-weight: 800; margin-bottom: 16px; }

  .cp-empty { text-align: center; padding: 32px; color: #3a3a3c; font-size: 13px; }
  .cp-error { color: #ff6b6b; font-size: 12px; margin-top: 6px; text-align: center; }

  /* SEND BTN */
  .cp-send-btn { background: #0066ff; color: white; border: none; border-radius: 8px; padding: 8px 14px; font-size: 12px; font-weight: 700; cursor: pointer; font-family: 'Inter', sans-serif; transition: opacity 0.15s; flex-shrink: 0; }
    ...
    <div className="cp-modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="cp-modal">
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 12 }}>
          <button onClick={onClose} style={{ background: 'none', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 7, padding: '6px 14px', color: '#8e8e93', cursor: 'pointer', fontSize: 12, fontWeight: 600, fontFamily: 'Inter, sans-serif' }}>Cerrar</button>
        </div>
      </div>
    </div>
  )
